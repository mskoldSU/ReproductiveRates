...
all: $(MCMC) $(FIGS) $(FIGS.SUPP) ReproductiveRates.pdf AppendixS1.pdf
...
AppendixS1.pdf: AppendixS1.Rmd mcmc_all.R load_data.R figures_supp.R $(FIGS) $(DATA) $(MCMC) MS_Bounded_rmax.bib
	Rscript --no-save -e 'rmarkdown::render("$<")'